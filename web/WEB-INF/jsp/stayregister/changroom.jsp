    ...
    <div class="span11" style=" border: solid; border-color: #DDDDDD;">
        ...
        <div class="span12">
            <div class="row-fluid">
                ...
                <div class="span3">
                    <label>出租方式：</label>
                    <input type="text" style="width:100%;height:27px;" readonly="readonly"
                           value="${item.rentOutType.category}">
                </div>
            </div>
        </div>
        ...
        <div class="span12">
            <div class="row-fluid">
                <div class="span3">
                    <label>登记时间：</label>
                    <input type="text" style="width:100%;height:27px;" readonly="readonly"
                           value="${item.stayRegisterTime}">
                </div>
                <div class="span3">
                    <label>房价/天：</label>
                    <input type="text" style="width:100%;height:27px;" readonly="readonly"
                           value="${item.room.standarPriceDay}">
                </div>
                <div class="span3">
                    <label>天数：</label>
                    <input type="text" style="width:100%;height:27px;" readonly="readonly" value="${item.stayNumber}">
                </div>
                <div class="span3">
                    <label>住宿费：</label>
                    <input type="text" style="width:100%;height:27px;" readonly="readonly" value="${item.sumConst}">
                </div>
            </div>
        </div>
        ...
        <div class="span12">
            <div class="row-fluid">
                ...
                <div class="span3">
                    <label>押金：</label>
                    <input type="text" style="width:100%;height:27px;" readonly="readonly" value="${item.deposit}">
                </div>
                <div class="span3">
                    <label>本次需交换房费：</label>
                    <input id="changRoomMoneyId" type="text" style="width:100%;height:27px;"
                           value="${zhuSuFei}">
                </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        <button data-dismiss="modal" class="btn btn-info btn-small textone" type="button"
                                onclick="changroomConfirmfunction()">
                            <li class="icon-plus icon-white"></li>
                            确定选择
                        </button>
                    </div>
