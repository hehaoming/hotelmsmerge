...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <form action="${ctx}/ReceiveTarget/update.do" method="post" onsubmit="return verify()">
		<input name="rt_id" value="${list.rt_id}" type="hidden">
	    <div class="span12">
	      <div class="row-fluid">
			  <div class="span5 ">
 ...
 <script type="text/javascript">
   ...
   function verify(){
    ...
    function deletefunction(){
        parent.document.getElementById('Mainid').src = '${ctx}/ReceiveTargetBean/tolist.do';
   }
     ...
     if(value!=""){
       $.ajax({                                                      
          ...
          type: "POST",                                           //上面3行都是必须要的
           url: '${ctx}/ReceiveTargetBean/YZ.do',       //地址 type 带参数
