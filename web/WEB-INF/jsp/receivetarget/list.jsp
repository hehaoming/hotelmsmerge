...
<%@ page import="com.hotelms.bean.ReceiveTargetBean" %>
<%@ page import="com.hotelms.bean.ListBean" %>
...
<div class="container">
    ...
    <div class="dgvone">
        <table class="table table-condensed table-bordered table-striped" id="tableid">
            ...
            <%--List<ReceiveTargetBean> items = list.getResult();--%>
            <%--request.setAttribute("items",items);--%>
            <%--%>--%>

            <c:forEach items="${list.result}" var="item">
                <tr>
                    <td><input type="checkbox" name="id" value="${item.rt_id}"></td>
...
<script type="text/javascript">
    function addfunction() {
        parent.document.getElementById('Mainid').src = '${ctx}/ReceiveTargetBean/toadd.do';
    }
    ...
    function updatefunction() {
        ...
        if (chk_value != "") {
            if (chk_value.toString().indexOf(",") > 0) {
                ...
                parent.document.getElementById("Mainid").src = '${ctx}/ReceiveTargetBean/toupdate.do?id=' + chk_value;
            }
        } else {
            alert("请选择一条数据进行修改");
        }
    ...
    function deletefunction() {
        ...
        if (chk_value != "") {
            ...
            if (flag) {
                parent.document.getElementById("Mainid").src = '${ctx}/ReceiveTargetBean/delete.do?rt_id=' + chk_value;
            }
        } else {
    ...
    $(".tcdPageCode").createPage({
        ...
        backFn: function (p) {
            ...
            location.href = "${ctx}/ReceiveTargetBean/tolist.do?currentPage=" + p + "&txtname=" + txtname;
        }
    });
