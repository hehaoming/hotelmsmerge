...
<div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span11" style=" border: solid; border-color: #DDDDDD;">
        ...
        <form id="form1" method="post" onsubmit="return verify()">
            <input type="hidden" id="tuanDuiIDId" value="${tuanDuiID}"/>
            <input id="roomId" name="room.roomID" type="hidden">
            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span3">
                        <label>房间号：</label>
                        <input id="roomNameId" name="room.roomNumber" type="text" style="width:100%;height:27px;"
                               readonly="readonly">
                    </div>
                    <div class="span3">
                        <label>登记时间：</label>
                        <input id="registerTimeId" name="StayRegisterTime" id="date"
                    ...
                    <div class="span3">
                        <label>出租方式：</label>
                        <select name="rentOutType.itemDetailsID" style="width:100%;height:27px;">
                            <c:forEach items="${listRentOutType}" var="item">
                                <option value="${item.itemDetailsID}"
                                        <c:if test="${item.itemDetailsID==74}">selected="selected"</c:if>>
                                        ${item.category}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="span3">
                        <label>旅客类别：</label>
                        <select name="passengerType.itemDetailsID" style="width:100%;height:27px;">
                            <c:forEach items="${listPassengerType}" var="item">
                                <option value="${item.itemDetailsID}"
                                        <c:if test="${item.itemDetailsID==76}">selected="selected"</c:if>>
                                        ${item.category}
                                </option>
                            </c:forEach>
                        </select>
            ...
            <div class="span12">
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <label>结账单位：</label>
                        <select name="billUnit.itemDetailsID" style="width:100%;height:27px;">
                            <c:forEach items="${listBillUnit}" var="item">
                                <option value="${item.itemDetailsID}"
                                        <c:if test="${item.itemDetailsID==78}">selected="selected"</c:if>>
                                        ${item.category}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="span3">
                        <label>支付方式：</label>
                        <select name="depositPayWay.itemDetailsID" style="width:100%;height:27px;">
                            <c:forEach items="${listPayWay}" var="item">
                                <option value="${item.itemDetailsID}"
                                        <c:if test="${item.itemDetailsID==80}">selected="selected"</c:if>>
                                        ${item.category}
                                </option>
                            </c:forEach>
                        </select>
        ...
        <div class="span12" id="dynamicid" style="height:270px;overflow-x:auto;">
            <div class="row-fluid" id="div1">
                <c:forEach items="${list}" var="item">
                    <c:if test="${item.roomState.itemDetailsID==1}">
                        <button onclick="suibian(this)"
                            ...
                            <input style="display: none;" value="${item.roomState.itemDetailsID}"/>
                            <label>${item.roomNumber}</label>
                            <label style="margin-top:-5px;">${item.roomState.category}</label>
                            <label style="margin-top:-5px;">${item.guestRoomLevel.category}</label>
                            <label style="margin-top:-5px;">￥${item.standarPriceDay}</label>
                            <input style="display: none;" value="${item.standarPrice}"/>
                            <input style="display: none;" value="${item.firstPrice}"/>
                            <input style="display: none;" value="${item.firstDuration}"/>
                        </button>
                    </c:if>
                    <c:if test="${item.roomState.itemDetailsID==2}">
                        <button onclick="suibian(this)"
                    ...
                    <c:if test="${item.roomState.itemDetailsID==3}">
                        <button onclick="suibian(this)"
                    ...
                    <c:if test="${item.roomState.itemDetailsID==8}">
                        <button onclick="suibian(this)"
                    ...
                    <c:if test="${item.roomState.itemDetailsID==9}">
                        <button onclick="suibian(this)"
                    ...
                    <c:if test="${item.roomState.itemDetailsID==10}">
                        <button onclick="suibian(this)"
                    ...
                    <c:if test="${item.roomState.itemDetailsID==11}">
                        <button onclick="suibian(this)"
...
<script type="text/javascript">
    ...
    function tijiao() {
        ...
        var LvKeLeiXingId = document.getElementById("LvKeLeiXingId").value;
        var tuanDuiIDId = document.getElementById("tuanDuiIDId").value;
        form1.action = "${ctx}/StayRegister/arrangeroom.do?LvKeLeiXingId=" + LvKeLeiXingId + "&tuanDuiId=" + tuanDuiIDId;
        form1.submit();
    }
        ...
        $.ajax({
            ...
            success: function (result) {                          // 不出现异常 进行立面方
                for (var key in result) {
                    var item = result[key];
                    if (item.roomState.itemDetailsID == 1) {
                    ...
                    if (item.roomState.itemDetailsID == 2) {
                    ...
                    if (item.roomState.itemDetailsID == 3) {
                    ...
                    if (item.roomState.itemDetailsID == 8) {
                    ...
                    if (item.roomState.itemDetailsID == 9) {
                    ...
                    if (item.roomState.itemDetailsID == 10) {
                    ...
                    if (item.roomState.itemDetailsID == 11) {
