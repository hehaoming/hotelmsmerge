		        ...
		        <label>民族：</label>
		         <select name="nationID" style="width:100%;height:27px;">
		            <c:forEach items="${listNation}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==74}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>文化程度：</label>
		         <select name="educationDegreeID" style="width:100%;height:27px;">
		            <c:forEach items="${listEducationDegree}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==35}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>旅客级别：</label>
		         <select name="passengerLevelID" style="width:100%;height:27px;">
		            <c:forEach items="${listPassengerLevel}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==57}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
