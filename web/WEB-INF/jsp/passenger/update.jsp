		     ...
		     <div class="span3">
		        ...
		        <select name="genderID" style="width:100%;height:26px;">
		            <c:forEach items="${listGender}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==list.genderID}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>民族：</label>
		         <select name="nationID" style="width:100%;height:26px;">
		            <c:forEach items="${listNation}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==list.nationID}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>文化程度：</label>
		         <select name="educationDegreeID" style="width:100%;height:26px;">
		            <c:forEach items="${listEducationDegree}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==list.educationDegreeID}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>旅客级别：</label>
		         <select name="passengerLevelID" style="width:100%;height:26px;">
		            <c:forEach items="${listPassengerLevel}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==list.passengerLevelID}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
		     ...
		     <div class="span3">
		        ...
		        <select id="papersId" name="papersID" style="width:100%;height:26px;">
		            <c:forEach items="${listPapers}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==list.papersID}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
		     ...
		     <div class="span3">
		        ...
		        <select name="thingReasonID" style="width:100%;height:26px;">
		            <c:forEach items="${listThingReason}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==list.thingReasonID}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
