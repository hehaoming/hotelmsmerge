...
<div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span11" style=" border: solid; border-color: #DDDDDD;">
        ...
        <form id="form1" method="post" onsubmit="return verify()">
            <input type="hidden" name="team.tuanduiID" value="${tuanDuiID}"/>
                ...
                <div class="row-fluid">
                    <div class="span8">
                        ...
                        <input id="txtnameid" name="txtname" class="textone"
                               style="width:60%; border-radius:0px; border-top-left-radius:4px; border-bottom-left-radius:4px;height:27px;"
    ...
    <script type="text/javascript">
        ...
        function selectRoom() {
            ...
            $.ajax({
                ...
                data: "roomNumber=" + name,                         // IDCardValue 自定义的。相当于name把值赋予给 他可以在servlet 获取                 // json 数据类型提交
                ...
                success: function (result) {
                    for (var key in result) {
                        ...
                        tdcheckbox.innerHTML = "<input type='checkbox' name='idTwo' value='" + item.roomID + "'>";
                        ...
                        tdstandardPriceDay.innerHTML = '￥' + item.standarPriceDay;
                    }
                    if (i == 0) {
            ...
            $.ajax({
                ...
                success: function (result) {                          // 不出现异常 进行立面方
                    for (var key in result) {
                        ...
                        tdcheckbox.innerHTML = "<input type='checkbox' name='id' value='" + item.roomID + "'>";
                        tdroomNumber.innerHTML = item.roomNumber;
                        tdguestRoomLevelName.innerHTML = item.guestRoomLevel.category;
                        tdroomAmount.innerHTML = item.roomAmount;
                        tdstandardPriceDay.innerHTML = '￥' + item.standarPriceDay;
                        tdstandardPrice.innerHTML = '￥' + item.standarPrice;
