...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <form action="${ctx}/RoomSet/update.do" method="post" onsubmit="return verify()">
	   <input type="hidden" name="id" value="${listPo.roomID}">
			  ...
			  <div class="span5 ">
			      ...
			      <select name="roomStateID" class="cboone inputone">
		            <c:forEach items="${listTwo}" var="item">
			          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==listPo.roomStateID}" >selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
			      ...
			      <select name="guestRoomLevelID" class="cboone inputone">
		            <c:forEach items="${listOne}" var="item">
			          <option value="${item.itemDetailsID}"
							  <c:if test="${item.itemDetailsID==listPo.guestRoomLevelID}">selected="selected"</c:if>>
			            ${item.category}
			          </option>
			        </c:forEach> 
		          </select>
	    ...
	    <div class="span12 margin-top-one" >
	      <div class="row-fluid">
		       ...
		       <div class="span6">
			      ...
			      <input id="standardPriceDayId" name="standarPriceDay" class="textone inputtwo radiusone" onblur="onchangeOne()" value="${listPo.standarPriceDay}"
	    ...
	    <div class="span12 margin-top-two">
	      <div class="row-fluid">
		      <div class="span5">
			      ...
			      <input id="standardPriceId" name="standarPrice" class="textone inputthree radiusone" onblur="onchangeOne()" value="${listPo.standarPrice}"
			      style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;" type="text">
