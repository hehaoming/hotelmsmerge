...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <input type="hidden" id="oneId">     <!--对象ID -->
    ...
    <div class="span2">
      <select id="stateId" style="width:80%;height:26px; float:left;margin-top:12px;" onchange="selectTwo()">
        <c:forEach items="${listOne}" var="item">
          <option value="${item.itemDetailsID}" <c:if test="${item.itemDetailsID==state}">selected="selected"</c:if>>
            ${item.category}
          </option>
        </c:forEach> 
	  </select>
        ...
        <div class="tab-pane active" id="tab1">
          <div class="row-fluid">
             <div class="span2">
              ...
              <div class="span2">
                  <label>联系电话：</label>
			      <input id="contactPhoneNumberId1" class="widthone" style="height: 25px;"  type="text" readonly="readonly">
             </div>
              <div class="span2">
                  <label>登记时间：</label>
          ...
          <div class="row-fluid">
             <div class="span2">
              ...
              <div class="span2">
               ...
               <div class="span2">
                  <label>联系电话：</label>
			      <input id="contactPhoneNumberId2" name="commodityName" class="widthone" style="height: 25px;"  type="text" readonly="readonly">
             </div>
              <div class="span2" style="margin-top:23px;;text-align: center;">
       ...
       <table class="table table-condensed table-bordered table-striped" id="tableid">
	      ...
	      <tbody id="tbody">
	        <c:forEach items="${list.result}" var="item">
		        <c:if test="${item.predetermineStateName=='未安排'}" >
		           <tr>
					  <td><input type="checkbox" name="id" value="${item.predetermineID}"></td>
					  <td>${item.roomset.roomNumber}</td>
					  <td>${item.roomset.guestRoomLevelName}</td>
		        ...
		        <c:if test="${item.predetermineStateName=='已安排'}" >
		           <tr style="color:red;">
					   <td><input type="checkbox" name="id" value="${item.predetermineID}"></td>
					   <td>${item.roomset.roomNumber}</td>
					   <td>${item.roomset.guestRoomLevelName}</td>
  ...
  <script type="text/javascript">
      ...
      function confirmfunction(){
          ...
          $.ajax({
              ...
              success: function (result) {
                  ...
                  document.getElementById("contactPhoneNumberId2").value=result;
      ...
      function confirmRarget(){
          ...
          document.getElementById("contactPhoneNumberId1").value=contactPhoneNumber;
          ...
          if(chk_value!=""){
              ...
              if(flag){
                  parent.document.getElementById("Mainid").src='${ctx}/Predetermine/arrangeRoom.do?id='
                      +chk_value+'&tiaoZhuan='+1;
              }else{
                  parent.document.getElementById("Mainid").src='${ctx}/Predetermine/arrangeRoom.do?id='
                      +chk_value+'&tiaoZhuan='+2;
              }
          }else{
